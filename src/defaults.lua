...
local entities = {
    ...
    Slack = _G.requirePackage("entities/slack", true),
    iTerm = _G.requirePackage("entities/iterm", true),
    Brave = _G.requirePackage("entities/brave", true),
}
...
function Defaults.createEntityEvents()
    local entityEvents = {
        ...
        { nil, "b", entities.Brave, { "Entities", "Brave" } },
        ...
        { nil, "t", entities.iTerm, { "Entities", "iTerm" } },
        { nil, "s", entities.Slack, { "Entities", "Slack" } },
